...
EXPOSE 8021/tcp
EXPOSE 5066/tcp 5066/udp 5088/tcp 5088/udp
EXPOSE 5061/tcp 5061/udp 5081/tcp 5081/udp
EXPOSE 7443/tcp
EXPOSE 5070/udp 5070/tcp
EXPOSE 64000-64100/udp
EXPOSE 32000-32100/udp
...
# docker run --net=host --name freeswitch -v ${PWD}/config/:/etc/freeswitch fs-docker:latest
